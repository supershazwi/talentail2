  ...
  <div class="container">
    <div class="row">
      <div class="col-12 col-lg-12">
        ...
        <!-- Form -->
          <form method="POST" action="/companies/{{$company->slug}}/save-company" enctype="multipart/form-data">
          {{ csrf_field() }}
          ...
          <div class="form-group">
            ...
            <input type="text" name="title" class="form-control" id="title" placeholder="Enter title" value="{{ $company->title }}" autofocus>
          </div>
          ...
          <div class="form-group">
            ...
            <input type="text" name="facebook" class="form-control" id="facebook" placeholder="Enter facebook" value="{{ $company->facebook }}">
          </div>
          <div class="form-group">
            <label>
              Twitter
            </label>
            <input type="text" name="twitter" class="form-control" id="twitter" placeholder="Enter twitter" value="{{ $company->twitter }}">
          </div>
          <div class="form-group">
            <label>
              LinkedIn
            </label>
            <input type="text" name="linkedin" class="form-control" id="linkedin" placeholder="Enter linkedin" value="{{ $company->linkedin }}">
          </div>
          <div class="form-group">
            <label>
              Email
